...
function inspectSlide(pptxPath, slideIdx, label) {
    ...
    const xml = zip.readAsText(slides[slideIdx]);
...
inspectSlide("C:\\Users\\Riddhi Dumre\\Desktop\\Presentation Automation\\SALES DECKS\\new MD\\V5_BDC_Styled.pptx", 5, "BEAM SLIDE (BFSI Deck)");
inspectSlide("C:\\Users\\Riddhi Dumre\\Desktop\\Presentation Automation\\SALES DECKS\\new MD\\BombayDC_B2B_POV_Deck-2 (1)_BDC_Styled.pptx", 8, "B2B CASE SLIDE (B2B Deck)");
