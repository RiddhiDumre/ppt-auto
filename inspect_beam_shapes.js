...
const pptxPath = "C:\\Users\\Riddhi Dumre\\Desktop\\BombayDC_Decks_With_BG_Images\\01_BombayDC_BFSI_POV_Deck.pptx";
...
const xml = zip.readAsText(slides[5]);
console.log("=== ALL SHAPES IN BFSI SLIDE 6 (BEAM) ===");
